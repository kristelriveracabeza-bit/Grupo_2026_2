...
resource "aws_lambda_function" "this" {
  ...
  # Conservamos tu configuración de DLQ
  dead_letter_config {
    target_arn = aws_sqs_queue.lambda_dlq.arn
  }
  
  # Conservamos todas las variables de entorno (las antiguas y las nuevas de main)
  environment {
    variables = {
    ...
    Statement = [
      {
        ...
        Condition = {
          ArnEquals = {
            "aws:SourceArn" = aws_lambda_function.this[0].arn
          }
        }
      }
    ]
